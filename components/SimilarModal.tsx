...
function BasisPicker({ onPick }: { onPick: (b: 'title_v2' | 'thumbnail_v2' | 'combined' | 'combined_v2') => void }) {
  const cards: Array<{ id: 'title_v2' | 'thumbnail_v2' | 'combined' | 'combined_v2'; label: string; desc: string; icon: React.ReactNode }> = [
    {
      id: 'combined_v2',
      label: 'Combined ✦',
      desc: 'Joint title + thumbnail embedding. Captures both what it pitches and how it looks in one space — best for finding videos with the same energy.',
      icon: (
        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 3a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V5a2 2 0 00-2-2H5zm0 0v18M21 12H3" />
        </svg>
      ),
    },
    {
