              ...
              <div key={v.id} className="bg-[#141414] border border-[#1f1f1f] rounded-xl overflow-hidden hover:border-[#333] transition">
                ...
                <div className="relative aspect-video bg-[#0a0a0a]">
                  ...
                  <button
                    ...
                    className="absolute bottom-2 right-2 w-8 h-8 rounded-full bg-amber-500 hover:bg-amber-400 disabled:bg-amber-500/50 shadow-lg ring-2 ring-black/40 flex items-center justify-center text-black transition z-10 group"
                  >
                    <svg className={`w-4 h-4 ${refreshingIds.has(v.id) ? 'animate-spin' : 'group-hover:rotate-90 transition-transform'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
