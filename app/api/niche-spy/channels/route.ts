...
export async function GET(req: NextRequest) {
  ...
  switch (sort) {
    ...
    // The per-channel "spike ratio" (MAX/AVG) sort lived here briefly but was
    // the wrong metric — it measured intra-channel variance, not outlier
    // performance. Outlier detection now lives in its own /niche/outliers
    // surface with a proper peer-bucket-median baseline.
