...
export async function GET(req: NextRequest) {
  try {
    ...
    const risingResult = await pool.query(`
      SELECT
        c.channel_id, c.channel_name, c.channel_url, c.channel_creation_date, c.sighting_count, c.avatar_url,
        c.first_seen_at, c.last_seen_at, c.subscriber_count,
      ...
      GROUP BY c.channel_id, c.channel_name, c.channel_url, c.channel_creation_date, c.sighting_count, c.avatar_url, c.first_seen_at, c.last_seen_at, c.subscriber_count
      ${rsHaving}
