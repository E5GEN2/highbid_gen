...
/**
 * The product-picker landing page. Used to live at /app/page.tsx
 * directly; extracted so the bare-domain route can be a server
 * component that conditionally redirects to /niche based on the
 * `homepage_to_niche` admin config. The dashboard itself still
 * needs `useSession` so it has to stay client-rendered.
 *
 * Still rendered at /welcome unconditionally — admins can always
 * reach the product picker even when the redirect flag is on.
 */
